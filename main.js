;(function (window) {
  ...
  let texts = ['HALO APRIL :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'APRIL SAYANG', 'TAP PELAN PELAN YA', 'LIAT', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'WKKWKWKW', 'APRIL SAYANG', 'AKU TAHU KAMU PASTI CAPEK', 'AKHIRNYA UDAH SELESAI YA', 'KADERISASI YANG LAMA INI', 'KAMU HEBAT BANGET TAUU', 'WANITA YANG KUAT YG KU KENAL', 'TETAP SEMANGAT YA', 'KAMU PASTI BISA', 'AKU BANGGA SAMA KAMU LOHH', 'INGAT SAYANG', 'JANGAN BANYAK STRES DAN MIKIR ANEH2', 'YASUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'SELAMAT SENANG-SENANG', 'BYE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU SEDIKIT KESAL']
